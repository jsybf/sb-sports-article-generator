...
internal fun BasketballMatchPage.extractMatchAt(): LocalDateTime {
...
internal fun BasketballMatchPage.extractLeague(): League.Basketball {
    val href = doc
        .selectFirst("""ol li:nth-child(3) a[itemprop="item"]""")!!
        .attr("href")

    return League.Basketball.entries.find { it.leagueName.lowercase() == href.split("/")[3] } ?: throw Exception("can't determine league from ${href}")
}

internal fun BasketballMatchPage.extractMatchSummary(): JsonObject = buildJsonObject {
