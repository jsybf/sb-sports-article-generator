...
internal fun HockeyMatchPage.extractMatchAt(): LocalDateTime {
...
internal fun HockeyMatchPage.extractLeague(): League.Hockey {
    val href = doc
        .selectFirst("""ol li:nth-child(3) a[itemprop="item"]""")!!
        .attr("href")

    return League.Hockey.entries.find { it.leagueName.lowercase() == href.split("/")[3] } ?: throw Exception("can't determine league from ${href}")
}

internal fun HockeyMatchPage.parseMatchSummary(): JsonObject = buildJsonObject {
