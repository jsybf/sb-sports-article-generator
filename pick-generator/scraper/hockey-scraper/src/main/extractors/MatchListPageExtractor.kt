...
fun HockeyMatchListPage.extractMatchInfo(): List<HockeyMatchInfo> {
    val league = this.doc
        .selectFirst(".heading__title .heading__name")!!.text()
        .let { League.findByName("hockey", it) ?: throw IllegalArgumentException("can't parse hocky team $it") }
        .let { it as League.Hockey }
