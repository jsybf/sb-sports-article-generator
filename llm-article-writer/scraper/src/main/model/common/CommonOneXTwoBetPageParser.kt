...
/**
 * html -> json 파싱은 귀찮다 그냥 llm한테 맡기자.
 * 아래는 llm이 작성한 코드 너무 길어서 [CommonOneXTwoBetPage] 에서 따로 추출함
 */
object CommonOneXTwoBetPageParser {
    fun CommonOneXTwoBetPage.parseOdds(): JsonArray = buildJsonArray {
