...
object BaseballStartingPitcherPageExtractor {

    fun extractPitcherStats(document: Document): JsonObject {
        return buildJsonObject {
            put("homePitcher", extractPitcherInfo(document, "home"))
            put("awayPitcher", extractPitcherInfo(document, "away"))
        }
    }
